...
Каталог (матчи, турниры, команды, статистика) открыт без регистрации. Аккаунт нужен, чтобы создавать команды (это делает капитан, не админ), судить и администрировать. Вход хранится во вкладке браузера: на ПК можно открыть разные аккаунты в разных вкладках.
